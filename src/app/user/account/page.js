                  ...
                  <div className={styles.preferencesGrid}>
                    ...
                    <div className={styles.preferenceCard}>
                      <div className={styles.preferenceHeader}>
                        ...
                        <div className={styles.preferenceInfo}>
                          <h3 className={styles.preferenceTitle}>SMS Notifications</h3>
                          <p className={styles.preferenceDesc}>
                    ...
                    <div className={styles.preferenceCard}>
                      <div className={styles.preferenceHeader}>
                        ...
                        <div className={styles.preferenceInfo}>
                          <h3 className={styles.preferenceTitle}>Cart Reminders</h3>
                          <p className={styles.preferenceDesc}>
                            Remind me about items in cart
                          </p>
                        </div>
                        <label className={styles.toggleSwitch}>
                          <input type="checkbox" defaultChecked />
                    ...
                    <div className={styles.preferenceCard}>
                      <div className={styles.preferenceHeader}>
                        ...
                        <div className={styles.preferenceInfo}>
                          <h3 className={styles.preferenceTitle}>Price Alerts</h3>
                          <p className={styles.preferenceDesc}>
